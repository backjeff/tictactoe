...
import com.backjeff.tictactoe.model.Player.O
import com.backjeff.tictactoe.model.Player.X
...
data class Board(
    ...
    fun copyOf(): Board {
        ...
        return Board(size, victoryLength, newRows)
    }
    ...
    private fun checkLineForWinner(
        rowIndex: Int,
        columnIndex: Int,
        xCounter: Int = 0,
        oCounter: Int = 0,
